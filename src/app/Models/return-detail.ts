...
export class ReturnDetail {
  ...
  constructor(ID: number, ReturnDetailID: string, OrderDetailID: string, ReturnID: string, ProductID: string, ProductName: string, Quantity: number, ReasonOfReturn: string, UnitPrice: number, TotalPrice: number, CreationDateTime: string, LastModifiedDateTime: string) {
    this.id = ID;
